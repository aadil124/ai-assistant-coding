      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          >
            ...
            <Typography variant="body1" color="text.secondary" sx={{ mb: 2.5, lineHeight: 1.8, fontSize: { xs: '0.875rem', md: '0.9375rem' } }}>
              I focus on implementing seamless REST API integrations, robust state management, and modern responsive design patterns to deliver premium user experiences. At NeoSoft, I build module screens for a leading public sector bank&apos;s HRMS Portal. Previously, I designed responsive interfaces for high-traffic gaming portals handling 4000+ games and client admin panels.
            </Typography>
