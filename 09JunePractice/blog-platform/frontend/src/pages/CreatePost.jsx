...
const CreatePost = () => {
  ...
  const savePost = async (status) => {
    ...
    try {
      ...
      setApiError(err.message || 'Error saving post.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="d-flex min-h-screen bg-white text-dark">
      ...
      >
        ...
        <nav className="nav flex-column flex-grow-1 gap-1">
          ...
          <Link className="nav-link bg-primary-subtle text-primary fw-bold d-flex align-items-center gap-2 px-3 py-2 rounded-2" to="/admin/create-post">
      ...
      >
        ...
        <header className="navbar navbar-light bg-white border-bottom px-4 sticky-top z-2" style={{ height: '64px' }}>
          <div className="d-flex align-items-center gap-3">
            ...
            <span className="text-secondary small">Draft in Posts</span>
          </div>
        </header>
      ...
      >
        ...
        <div className="d-flex flex-column gap-3 overflow-y-auto flex-grow-1">
          ...
          <div className="mt-4 pt-3 border-top">
            <div className="text-secondary small fw-bold text-uppercase tracking-wider mb-2">
              Settings Info
            </div>
            <div className="d-flex justify-content-between align-items-center py-2 text-secondary small">
