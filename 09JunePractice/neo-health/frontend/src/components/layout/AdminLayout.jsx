  ...
  return (
    <div className="min-vh-100 d-flex flex-column bg-light text-dark">
      ...
      <header className="d-lg-none bg-white border-bottom px-3 py-2 d-flex justify-content-between align-items-center sticky-top z-3">
        <Link className="d-flex align-items-center gap-2 text-decoration-none fw-bold text-dark" to="/admin/dashboard">
      ...
      <div className="d-flex flex-grow-1 position-relative">
        ...
        >
          ...
          <div className="mb-4 px-2 pt-2">
            <Link className="d-flex align-items-center gap-2 text-decoration-none" to="/admin/dashboard">
            ...
            <small className="text-secondary tracking-wide fw-medium text-uppercase ps-1">Admin Portal</small>
          </div>
        ...
        {/* Main Content Area */}
        <div className="flex-grow-1 d-flex flex-column min-w-0" style={{ paddingLeft: '0', transition: 'padding 0.3s ease' }} id="admin-content-wrapper">
          {/* Top Header */}
          <header className="d-none d-lg-flex bg-white border-bottom px-4 py-3 justify-content-between align-items-center sticky-top z-2">
            <div className="d-flex align-items-center gap-3 bg-light px-3 py-2 rounded-pill border" style={{ width: '380px' }}>
              ...
              <input
                ...
                placeholder="Search audits, users, actions..."
                id="header-search-bar"
                onKeyDown={(e) => {
                  if (e.key === 'Enter' && e.target.value.trim()) {
                    alert(`Simulated search: "${e.target.value}". Found 3 items.`);
                  }
                }}
              />
            </div>
            ...
            <div className="d-flex align-items-center gap-4">
              ...
              <div className="d-flex align-items-center gap-2">
                <button
                  ...
                  type="button"
                  onClick={() => alert("Verification Queue: 1 pending doctor file.")}
                >
              ...
              <div className="d-flex align-items-center gap-3">
                <div className="text-end">
                  <p className="fw-semibold text-dark mb-0 small">Admin User</p>
