  ...
  return (
    <div className="min-vh-100 d-flex flex-column bg-light">
      ...
      <header className="d-lg-none bg-white border-bottom px-3 py-2 d-flex justify-content-between align-items-center sticky-top z-3">
        <Link className="d-flex align-items-center gap-2 text-decoration-none fw-bold text-dark" to="/">
      ...
      <div className="d-flex flex-grow-1 position-relative">
        ...
        >
          ...
          <div className="border-top pt-3 mt-auto d-flex flex-column gap-2">
            <button className="btn btn-danger w-100 py-2.5 d-flex align-items-center justify-content-center gap-2 rounded-3 small fw-semibold" type="button">
          ...
          <header className="d-none d-lg-flex bg-white border-bottom px-4 py-3 justify-content-between align-items-center sticky-top z-2">
            ...
            <div className="d-flex align-items-center gap-4">
              <div className="d-flex align-items-center gap-2">
                ...
                <button className="btn btn-light border rounded-circle p-2 d-flex align-items-center justify-content-center" type="button">
