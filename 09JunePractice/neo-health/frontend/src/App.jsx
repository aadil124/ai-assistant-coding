                ...
                <div className="d-flex flex-column min-vh-100">
                  ...
                  <main className="flex-grow-1">
                    <Routes>
                      ...
                      <Route path="/patient/doctors" element={<PatientRoute><DoctorListing /></PatientRoute>} />
                      <Route path="/patient/doctor/:id" element={<PatientRoute><DoctorProfile /></PatientRoute>} />
                      <Route path="/patient/booking/select-slot/:id" element={<PatientRoute><SelectSlot /></PatientRoute>} />
                      <Route path="/patient/booking/summary/:id" element={<PatientRoute><BookingSummary /></PatientRoute>} />
                      <Route path="/patient/booking/success" element={<PatientRoute><BookingSuccess /></PatientRoute>} />
                      <Route path="/patient/consultation/waiting-room/:id" element={<PatientRoute><WaitingRoom /></PatientRoute>} />
                      <Route path="/patient/consultation/completed/:id" element={<PatientRoute><ConsultationCompleted /></PatientRoute>} />
                      <Route path="/patient/appointments" element={<PatientRoute><MyAppointments /></PatientRoute>} />
                      <Route path="/patient/appointments/:id" element={<PatientRoute><AppointmentDetails /></PatientRoute>} />
                      <Route path="/patient/records/prescriptions" element={<PatientRoute><MyPrescriptions /></PatientRoute>} />
                      <Route path="/patient/records/view/:id" element={<PatientRoute><MedicalRecordViewer /></PatientRoute>} />
                      <Route path="/patient/medical-records" element={<PatientRoute><MedicalRecordsList /></PatientRoute>} />
                      <Route path="/patient/doctor/review/:id" element={<PatientRoute><WriteReview /></PatientRoute>} />
                      <Route path="/patient/notifications" element={<PatientRoute><Notifications /></PatientRoute>} />
                      <Route path="/patient/profile" element={<PatientRoute><MyProfile /></PatientRoute>} />
                      ...
                      <Route path="/doctor/consultation/:appointmentId" element={<DoctorRoute><DoctorConsultation /></DoctorRoute>} />
                      <Route path="/doctor/prescriptions/new" element={<DoctorRoute><DoctorPrescriptionGen /></DoctorRoute>} />
                      <Route path="/doctor/records/upload" element={<DoctorRoute><DoctorRecordUpload /></DoctorRoute>} />
                      ...
                      <Route path="/admin/doctors/pending" element={<AdminRoute><DoctorVerification /></AdminRoute>} />
