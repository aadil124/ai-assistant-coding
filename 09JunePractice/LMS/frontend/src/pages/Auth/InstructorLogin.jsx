        ...
        <section className="col-lg-6 branding-side d-none d-lg-flex align-items-center justify-content-center p-5 position-relative overflow-hidden">
          ...
          <div className="parallax-wrap w-100" style={{ maxWidth: '500px' }} id="parallax-container">
            <div className="d-flex align-items-center gap-2 mb-5 text-start">
              <span className="material-symbols-outlined fs-3 text-primary">auto_awesome</span>
              <span className="h5 fw-bold text-white mb-0">EduFlow Academy</span>
            </div>
            ...
            <div className="text-start">
              ...
              <p className="text-white text-opacity-70 mb-5" style={{ fontSize: '1.05rem', lineHeight: '1.6' }}>
                Join an elite community of educators. EduFlow provides the high-performance tools you need to build sequential curriculums, trace student progression, and analyze score dynamics.
              </p>
            </div>

            <div className="d-flex flex-wrap gap-2">
              <span className="badge-premium badge-premium-primary border border-primary border-opacity-20 px-3 py-2 text-white small d-flex align-items-center gap-1.5" style={{ background: 'rgba(37, 99, 235, 0.15)', color: '#93c5fd' }}>
        ...
        <section className="col-lg-6 d-flex align-items-center justify-content-center p-4 p-md-5 bg-white">
          <div className="w-100" style={{ maxWidth: '380px' }}>
            <div className="d-flex d-lg-none align-items-center justify-content-center gap-2 mb-4">
              <span className="material-symbols-outlined fs-4 text-primary">local_library</span>
            ...
            <header className="mb-4 text-start">
              ...
              <p className="text-secondary small">Sign in to manage your academy, courses, and analytics.</p>
            </header>
            ...
            <form onSubmit={handleSubmit} className="d-flex flex-column gap-3 text-start">
              <div className="form-group-premium">
                ...
                <div className="position-relative">
                  <span className="material-symbols-outlined position-absolute text-secondary" style={{ left: '12px', top: '10px', fontSize: '18px' }}>mail</span>
                  <input
                    id="email"
                    type="email"
                    required
              ...
              <div className="form-group-premium">
                <div className="d-flex justify-content-between align-items-center mb-1">
                  <label className="label-premium mb-0" htmlFor="password">Password</label>
                  <a className="small text-primary text-decoration-none" href="#" style={{ fontSize: '11px' }}>Forgot Password?</a>
                </div>
                <div className="position-relative">
                  <span className="material-symbols-outlined position-absolute text-secondary" style={{ left: '12px', top: '10px', fontSize: '18px' }}>lock</span>
                  <input
                    id="password"
              ...
              <div className="form-check my-1">
                <input className="form-check-input" type="checkbox" id="remember" style={{ cursor: 'pointer' }} />
                <label className="form-check-label text-secondary small select-none cursor-pointer" htmlFor="remember">
            ...
            <div className="text-center mt-4 border-top pt-3">
              <p className="text-secondary small mb-0">
                Are you a learner? <Link to="/login" className="text-primary fw-bold text-decoration-none">Student Sign In</Link>
              </p>
            </div>
          </div>
        </section>
